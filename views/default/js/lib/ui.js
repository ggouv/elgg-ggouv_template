...
elgg.ui.toggles = function(event) {
	...
	if (texta) $(texta).parent().find('.elgg-preview-longtext').width($(texta).width()-11);
};
...
elgg.ui.popupOpen = function(event) {
	...
	$target.appendTo('.elgg-page-body')
		.fadeIn()
		.position(options);
 ...
 * @return void
 */
elgg.ui.requiresConfirmation = function(e, link) {
	var confirmText = link.attr('rel') || elgg.echo('question:areyousure');
