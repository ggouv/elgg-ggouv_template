...
if ($duedate) {
	...
	$due_date_string = "<div class='workflow-card-duedate$overdue'>" . elgg_view_icon('workflow-calendar') . strftime(elgg_echo('workflow:card:view:duedate'), $duedate_timestamp) . "</div>";
}
